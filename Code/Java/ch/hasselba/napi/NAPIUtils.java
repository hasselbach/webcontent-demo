...
public class NAPIUtils {
	 ...
	 * 
	 */
	static public InputStream loadBinaryFile(final String serverName,
			final String dbPath, final String fileName) {
		...
		try {
			...
			// open database
			try {
				nDatabase = nSession.getDatabaseByPath(serverName + "!!"
						+ dbPath);
